            ...
            <Grid Grid.Row="1">
                <StackPanel Margin="20,10,20,20">
                    ...
                    <DockPanel>
                        ...
                        <Slider x:Name="XLeftSlider" Style="{StaticResource SliderStyle}" Minimum="0" Maximum="500" Value="0"/>
                    </DockPanel>
                    ...
                    <DockPanel>
                        ...
                        <Slider x:Name="XRightSlider" Style="{StaticResource SliderStyle}" Minimum="0" Maximum="500" Value="0"/>
                    </DockPanel>
                    ...
                    <DockPanel>
                        ...
                        <Slider x:Name="YDownSlider" Style="{StaticResource SliderStyle}" Minimum="0" Maximum="500" Value="0"/>
                    </DockPanel>
                    ...
                    <DockPanel>
                        ...
                        <Slider x:Name="YUpSlider" Style="{StaticResource SliderStyle}" Minimum="0" Maximum="500" Value="0"/>
                    </DockPanel>
