...
$presetPath = "$env:USERPROFILE\Documents\RecoilPresets"
                ...
                <Grid Margin="0,0,0,15">
                    ...
                    <Border Background="#141414" 
                        ...
                        <StackPanel>
                            ...
                            <TextBlock Text="Minimize window to activate" 
                                       Foreground="#B0B0B0"
                                       HorizontalAlignment="Center"
                                       FontSize="12"
                                       Margin="0,5,0,0"/>
...
$script:verticalRecoilMode = "High (8)"
$script:verticalRecoilStrength = 0
$script:verticalCustomStrength = 0
...
$verticalTimer.Add_Tick({
    # Only run when window is minimized
            ...
            if ($toggleActive) {
                ...
                if ([MouseMover]::GetAsyncKeyState(0x02)) {
                    ...
                    if ([MouseMover]::GetAsyncKeyState(0x01)) {
                        ...
                        # Apply the vertical delay rate
                        if ($script:verticalDelay -gt 0) {
                            Start-Sleep -Milliseconds $script:verticalDelay
                        }
                    }
                }
            }
                ...
                if ([MouseMover]::GetAsyncKeyState(0x02)) {
                    ...
                    if ([MouseMover]::GetAsyncKeyState(0x01)) {
                        ...
                        if ($script:horizontalStrength -gt 0) {
                            ...
                            # Apply the horizontal delay rate
                            if ($script:horizontalDelay -gt 0) {
                                Start-Sleep -Milliseconds $script:horizontalDelay
                            }
                        }
                    }
                }
